...
API Spec download from [RealWork API repo](https://github.com/gothinkster/realworld/tree/master/api)
...
```
APIURL=https://conduit.productionready.io/api bash ./run-api-tests.sh
```
